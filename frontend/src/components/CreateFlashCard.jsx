...
function CreateFlashCard () {
  ...
  return (
    <div className='max-w-7xl mx-auto bg-gray-100 min-h-screen p-6'>
      <header className='bg-black rounded-lg shadow-md p-6 mb-8 flex justify-between items-center'>
        ...
        <button
          className='bg-green-600 text-white font-semibold py-2 px-4 sm:px-6 rounded-full hover:bg-green-700 transition duration-300 flex items-center space-x-2 text-sm sm:text-base'
      ...
      <main className='space-y-8'>
        <div className='bg-black rounded-lg shadow-md p-6'>
          <label
            htmlFor='pack-name'
            className='text-xl font-semibold text-white block mb-2'
          >
            Pack Name
          </label>
          <input
            type='text'
            id='pack-name'
            placeholder='Enter name for pack'
        ...
        {flashcards.map((card, index) => (
          <div key={card.id} className='bg-black rounded-lg shadow-md p-6'>
            ...
            <div className='grid md:grid-cols-2 gap-6'>
              <div className='space-y-2'>
                <label className='font-medium text-white block'>Front</label>
                <textarea
              ...
              <div className='space-y-2'>
                <label className='font-medium text-white block'>Back</label>
                <textarea
        ...
        <button
          ...
          className='w-full bg-blue-900 hover:bg-blue-700 text-black font-semibold py-3 rounded-lg transition duration-300'
        >
          + Add Flashcard
        </button>
      </main>
