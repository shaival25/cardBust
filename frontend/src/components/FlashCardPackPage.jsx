...
const FlashcardPackPage = () => {
  ...
  return (
    <div className='min-h-screen bg-gray-500 py-12 px-4'>
      <div className='max-w-4xl mx-auto'>
        <Link
          to='/'
          className='inline-flex items-center text-blue-900 hover:text-blue-500 mb-8'
        >
        ...
        <div className='bg-black rounded-xl shadow-lg p-8 mb-8'>
          <FlashcardComponent
