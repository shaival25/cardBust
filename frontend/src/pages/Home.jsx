...
const HomePage = () => {
  ...
  return (
    <div className='min-h-screen text-gray-800 bg-gray-500'>
      <main className='max-w-7xl mx-auto px-4 py-12'>
        <section className='mb-16'>
          <h2 className='text-3xl font-semi-bold mb-8 text-gray-900'>
            Create Flashcards
          </h2>
          <div className=''>
            <Link
              to='/create-flashcard'
              className='flex items-center justify-between bg-black hover:bg-gray-700 text-white p-8 rounded-xl transition duration-300 shadow-lg hover:shadow-xl'
            >
              <div className='flex items-center space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-green-100'>
                    Create personalized flashcards to make studying easier and
                    more effective, tailored to your learning needs.
                  </p>
                </div>
              </div>
        ...
        <section>
          <div className='flex justify-between items-center mb-8'>
            <h2 className='text-xl sm:text-3xl font-semi-bold text-gray-900'>
              Previous Flashcards
            </h2>
            <Link
              to='/create-flashcard'
              className='bg-blue-600 text-white font-semibold py-2 px-4 sm:px-6 rounded-full hover:bg-blue-900 transition duration-300 flex items-center space-x-2 text-sm sm:text-base'
            >
          ...
          {loading ? (
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
              {flashcards.map(deck => (
                <div
                  key={deck.id}
                  className='flex flex-col justify-between bg-black rounded-xl p-6 hover:shadow-lg hover:bg-gray-700 transition duration-300'
                >
